  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h1 class="modal-title" id="exampleModalLabel">Rate {{$products->name}}</h1>
...
<div class="py-3 mb-4 shadow-sm bg-warning">
    <div class="container">
        <h6 class="mb-0">
            ...
            <a class ="route-nav" href="{{url('category/'.$products->category->slug)}}">
                {{$products->category->name}}
            </a> /
            <a class ="route-nav" href="{{url('category/'.$products->category->slug.'/'.$products->slug)}}">
                {{$products->name}}
            </a>
        </h6>
    </div>
