...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{url('insert-location')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-3 py-3">
                        <input type="text" class="form-control" name="latitude" id="_latitude" value="{{ old('latitude') ?? '0' }}" />
                    </div>
                    <div class="col-md-3 py-3">
                        <input type="text" class="form-control" name="longitude" id="_longitude" value="{{ old('longitude') ?? '0' }}" />
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="email" name="email" rows="3" class="form-control">
                    </div>
                    <div class="col-md-12 mb-3">
    ...
    <script>
        ...
        function initMap() {
            ...
            const uluru = {lat: 1.9344, lng: 103.3587};
